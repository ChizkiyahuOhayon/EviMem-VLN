...
MODEL_INJECTION_POINT = (
    "gavln/model/model_gavln.py::encode_images, at MemoryBackend.build_tokens before "
    "pos_encoding/mm_projector"
)
EVALUATOR_PUSH_POINT = "gavln/eval_runtime.py, inside len(action_seq) == 0"


class Phase0MemoryState:
    """Asset-free reference adapter for the production contracts.

    The Torch production implementation is ``evimem.torch_backend``; this
    NumPy adapter remains independent of GA-VLN's heavy dependencies for CI.
    """
